...
/**
 * A Kotlin class representing the ChromeCustomTabs HybridObject.
 * Implement this abstract class to create Kotlin-based instances of ChromeCustomTabs.
 */
@DoNotStrip
@Keep
@Suppress("RedundantSuppression", "KotlinJniMissingFunction", "PropertyName", "RedundantUnitReturnType", "unused")
abstract class HybridChromeCustomTabsSpec: HybridObject() {
  @DoNotStrip
  ...
  @DoNotStrip
  @Keep
  abstract fun launch(params: ChromeCustomTabsLaunchParams): Unit

  private external fun initHybrid(): HybridData

  companion object {
    private const val TAG = "HybridChromeCustomTabsSpec"
    init {
      try {
