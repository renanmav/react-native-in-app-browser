///
/// HybridSFSafariViewControllerSpec.kt
...
/**
 * A Kotlin class representing the SFSafariViewController HybridObject.
 * Implement this abstract class to create Kotlin-based instances of SFSafariViewController.
 */
@DoNotStrip
@Keep
@Suppress("RedundantSuppression", "KotlinJniMissingFunction", "PropertyName", "RedundantUnitReturnType", "unused")
abstract class HybridSFSafariViewControllerSpec: HybridObject() {
  @DoNotStrip
  ...
  companion object {
    private const val TAG = "HybridSFSafariViewControllerSpec"
    init {
      try {
